      ...
      >
        ...
        >
          <p className="mb-10 max-w-2xl font-Ovo text-justify">
            I am a experienced developer with a demonstrated history of working
            in the information technology and services industry. Skilled in
            JavaScript, React, Node.js, Express.js, and MongoDB. Strong
            engineering professional with a Bachelor of Science (BSc)(Hons) in
